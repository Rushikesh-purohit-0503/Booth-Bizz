...
const EditExpensePopup = ({ isOpen, onClose, onSubmit, existingData }) => {
    ...
    useEffect(() => {
        if (isOpen) {
            reset(existingData); // Reset form fields to existing data
        }
    ...
    return (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center">
            <div className="bg-white p-5 rounded-lg w-80 relative">
                ...
                <h3 className="text-lg font-semibold mb-4">Edit your Expense</h3>
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col">
                    <label htmlFor="edit-description" className="mb-1 text-left">Description</label>
                    <input 
                        type="text" 
                        id="edit-description" 
                    ...
                    <label htmlFor="edit-category" className="mb-1 text-left">Category</label>
                    <input 
                        type="text" 
                        id="edit-category" 
                    ...
                    <label htmlFor="edit-amount" className="mb-1 text-left">Amount</label>
                    <input 
                        type="number" 
                        id="edit-amount" 
                    ...
                    <label htmlFor="edit-date" className="mb-1 text-left">Date</label>
                    <input 
                        type="date" 
                        id="edit-date" 
