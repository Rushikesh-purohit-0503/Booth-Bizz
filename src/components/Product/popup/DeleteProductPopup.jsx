    ...
    >
      ...
      >
        ...
        <div className="flex flex-col items-center text-center">
          ...
          <h3 className="text-xl font-bold mb-2 text-gray-800">Confirm Product Deletion</h3>
          <p className="text-gray-600 mb-6">Are you sure you want to delete this product? This action cannot be undone.</p>
          
          <div className="flex justify-center space-x-4 w-full">
            <button
              className="bg-red-300 text-gray-800 py-2 px-6 rounded-lg hover:bg-red-400 transition duration-300 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-opacity-50"
              onClick={onConfirm}
            >
              Delete
            </button>
